...
\begin{figure}
\subfloat[Plateau initial de pong]{\includegraphics[width=0.49\linewidth]{pong-plateau.png}}
\subfloat[Plateau filtré]{\includegraphics[width=0.49\linewidth]{pong-filter.png}}
\centering
